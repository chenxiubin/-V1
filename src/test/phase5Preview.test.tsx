...
describe('Phase 5-A-2: Preview', () => {
  ...
  const validProduct = {id: 'p1', name: 'p1', mimeType: 'image/png', width: 100, height: 100, hasAlpha: false, persistedAssetRef: 'ref1', createdAt: ''} as any;
  ...
  const validScene = {id: 'a1', name: 's1', mimeType: 'image/png', width: 100, height: 100, persistedAssetRef: 'ref2', createdAt: ''} as any;
