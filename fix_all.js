...
replaceFile('src/test/canvasPreviewRenderer.test.tsx', 
  /sceneAsset:\s*\{\s*id:\s*'test-scene',\s*name:\s*'scene\.png',\s*mimeType:\s*'image\/png',\s*width:\s*800,\s*height:\s*800,\s*persistedAssetRef:\s*'blob:test2',\s*createdAt:\s*'now'\s*\}/, 
...
replaceFile('src/test/projectStore.test.ts',
  /\{ id: 'scene-id', name: 'scene\.jpg', mimeType: 'image\/jpeg', width: 800, height: 600, persistedAssetRef: 'scene-blob-ref', createdAt: 'now' \}/g,
